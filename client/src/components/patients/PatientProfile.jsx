    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div className="px-8 py-6 space-y-8">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Medical Information</h3>
            <dl className="divide-y divide-gray-200">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Emergency Contact</h3>
            <dl className="divide-y divide-gray-200">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">System Information</h3>
            <dl className="divide-y divide-gray-200">
