...
const InputField = ({ label, name, type = 'text', required = false, placeholder, error, value, onChange, loading }) => (
  <div>
    ...
    <input
      ...
      className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none ${error ? 'border-red-400 bg-red-50' : 'border-gray-300 dark:border-gray-600'}`}
      disabled={loading}
    />
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">Fill in the patient's information below</p>
      </div>

      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
        <form onSubmit={handleSubmit} className="space-y-8">
          {apiError && (
            <div className="flex items-center p-4 text-sm text-red-700 bg-red-50 rounded-lg border border-red-200 dark:border-red-800" role="alert">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Personal Information</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Contact Information</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <textarea id="address" name="address" value={formData.address} onChange={handleChange} rows={3} placeholder="123 Main St, City, State, ZIP"
                  className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none resize-none" disabled={loading} />
              </div>
            </div>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Medical Information</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Emergency Contact</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
            <button type="button" onClick={() => navigate('/patients')} disabled={loading}
              className="flex-1 py-3 px-4 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 disabled:bg-gray-50 text-gray-700 dark:text-gray-300 font-semibold rounded-lg transition-colors">Cancel</button>
